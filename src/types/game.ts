...
export type GameAllianceUpkeepCost =
  | "none"
  | "cheap"
  | "standard"
  | "expensive";
export type GameWarpgateCost = "none" | "cheap" | "standard" | "expensive";
export type GameSpecialistCost =
  | "none"
  | "standard"
  | "expensive"
  | "veryExpensive"
...
export type GameDarkGalaxyMode =
  | "disabled"
  | "fog"
  | "standard"
  | "extra"
...
export type GameInfrastructureCost =
  | "none"
  | "cheap"
  | "standard"
  | "expensive";
...
export type GameTimeStartDelay =
  | 0
  | 1
  | 5
  | 10
  ...
  | 720
  | 1440;
export type GameTimeMaxTurnWait =
  | 1
  | 5
  | 10
  | 30
